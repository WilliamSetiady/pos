...
$queryProduct = mysqli_query($config, "SELECT * FROM products ORDER BY p_id Desc");
$rowProducts = mysqli_fetch_all($queryProduct, MYSQLI_ASSOC);

$queryNoTrans = mysqli_query($config, "SELECT MAX('tr_id') as id_trans FROM transaction");
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tr_num"
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?= $_name ?>">
                                    <input type="hidden" class="form-control" value="<?= $_id ?>" readonly>
                                </div>
                            </div>
...
<script>
    ...
    button.addEventListener("click", function() {
        ...
        <td><input type='number' name='td_qty[]'></td>
        <td><input type='number' name='td_total[]'></td>
